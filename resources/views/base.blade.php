...
<head>
    ...
    <link rel=“canonical” href="{{ (isset($canonical_url)) ? $canonical_url : '' }}" />
    <!-- Favicon -->
    <link href="{{ asset('/assets/images/aurega/favicon.ico') }}" rel="shortcut icon">
    <!-- CSS -->
            ...
            <div class="container">
                <div class="row align-items-center g-2 g-lg-3">
                    <div class="col-12 col-md-6 text-center text-md-start">
                        <p>&copy; {{ date('Y') }} <a href="https://auregagroup.com" target="_blank">Aurega Group Limited</a>. All Rights Reserved.</p>
                    </div>
                </div><!-- end row -->
            </div><!-- end container -->
        </div>
