...
<div class="section">
    <div class="container">
        <div class="mb-5">
            <div class="row text-center">
                <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
                    <h1 class="fw-light">Team of highly skilled people are ready to work for you</h1>
                </div>
            </div>
        </div>
        <div class="row g-4 g-lg-5 icon-3xl text-center">
            <!-- Service box 1 -->
            <div class="col-12 col-md-6 col-lg-4">
                <div class="circle-box-lg bg-light-turquiose mb-3">
                    <i class="bi bi-building text-turquiose"></i>
                </div>
                <h2 class="fw-normal">Company Incorporation</h2>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="circle-box-lg bg-light-turquiose mb-3">
                    <i class="bi bi-card-heading text-turquiose"></i>
                </div>
                <h2 class="fw-normal">Golden Visa</h2>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="circle-box-lg bg-light-turquiose mb-3">
                    <i class="bi bi-cash-coin text-turquiose"></i>
                </div>
                <h2 class="fw-normal">Business Consulting</h2>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <h2 class="fw-normal">Trade Licenses</h2>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <h2 class="fw-normal">PRO Services</h2>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <h2 class="fw-normal">Intellectual Property</h2>
        ...
        <div class="mt-5 text-center">
            <a class="button button-lg button-rounded button-turquiose" href="/contact">Get In Touch</a>
        </div>
    </div><!-- end container -->
</div>
@endsection