                    ...
                    <form method="post" action="{{ route('blog.save') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                {{ html()->select($name='category', $value=array('Blog'=>'Blog', 'Guide'=>'Guide'))->placeholder('Select Category')->required()}}
                            </div>
                            <div class="col-12 mt-3">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                {{ html()->select($name='status', $value=array('0'=>'Draft', '1'=>'Publish'))->placeholder('Select Status')->required()}}
                            </div>
